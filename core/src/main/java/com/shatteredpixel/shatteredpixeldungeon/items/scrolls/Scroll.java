...
public abstract class Scroll extends Item {
  ...
  private static final LinkedHashMap<String, Integer> runes =
  ...
  public static void initLabels() {
    handler = new ItemStatusHandler<>(
        (Class<? extends Scroll>[])Generator.Category.SCROLL.classes, runes);
  }
      ...
      if (hero.buff(MagicImmune.class) != null) {
        ...
        GLog.w(Messages.get(this, "blinded"));
                 ...
                 !(this instanceof ScrollOfRemoveCurse ||
                   this instanceof ScrollOfAntiMagic)) {
  ...
  public static class ScrollToStone extends Recipe {
    ...
    private static HashMap<Class<? extends Scroll>, Class<? extends Runestone>>
        stones = new HashMap<>();
    static {
    ...
    public boolean testIngredients(ArrayList<Item> ingredients) {
      if (ingredients.size() != 1 || !(ingredients.get(0) instanceof Scroll) ||
