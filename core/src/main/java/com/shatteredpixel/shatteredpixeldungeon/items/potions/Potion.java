...
public class Potion extends Item {
  ...
  public static final String AC_EXAM = "EXAM";
  ...
  private static final LinkedHashMap<String, Integer> colors =
  ...
  protected static final HashSet<Class<? extends Potion>> mustThrowPots =
      new HashSet<>();
  static {
  ...
  public static void initColors() {
    handler = new ItemStatusHandler<>(
        (Class<? extends Potion>[])Generator.Category.POTION.classes, colors);
  }
  ...
  public void doThrow(final Hero hero) {
    ...
    if (isKnown() && !mustThrowPots.contains(this.getClass()) &&
      ...
      GameScene.show(new WndOptions(
          new ItemSprite(this), Messages.get(Potion.class, "beneficial"),
  ...
  public static class SeedToPotion extends Recipe {
    ...
    public static HashMap<Class<? extends Plant.Seed>, Class<? extends Potion>>
        types = new HashMap<>();
    static {
    ...
    public Item brew(ArrayList<Item> ingredients) {
      ...
      if ((seeds.size() == 2 && Random.Int(4) == 0) ||
        ...
        result = Reflection.newInstance(
            types.get(Random.element(ingredients).getClass()));
      }
