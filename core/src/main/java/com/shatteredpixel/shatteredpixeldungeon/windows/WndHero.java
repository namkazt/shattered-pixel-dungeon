...
public class WndHero extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		public void initialize(){
			...
			int intBonus = hero.INT() - hero.INT;
			if (intBonus > 0)           statSlot( Messages.get(this, "int"), hero.INT + " + " + intBonus );
			else if (intBonus < 0)      statSlot( Messages.get(this, "int"), hero.INT + " - " + -intBonus );
			else                        statSlot( Messages.get(this, "int"), hero.INT() );
